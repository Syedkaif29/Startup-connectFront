  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.role === 'STARTUP') {
        ...
        if (!formData.companyName || !formData.sector || !formData.investmentRangeMin || 
            !formData.investmentRangeMax || !formData.location || !formData.investmentFocus) {
      ...
      if (formData.role === 'STARTUP') {
        ...
        registrationData.investmentRangeMin = formData.investmentRangeMin;
        registrationData.investmentRangeMax = formData.investmentRangeMax;
